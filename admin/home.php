...
$admin = mysqli_query($mysqli, "SELECT * FROM tb_alternatif where hak_akses='admin'  ");
						...
						<div class="card bg-info">
							<div class="card-body">
								<div class="media align-items-center">
									...
									<div class="media-body text-right">
										<p class="fs-18 text-white mb-2">Jumlah Penilaian</p>
						...
						<div class="card bg-success">
							<div class="card-body">
								<div class="media align-items-center">
									...
									<div class="media-body text-right">
										<p class="fs-18 text-white mb-2">Data Karyawan</p>
						...
						<div class="card bg-secondary">
							<div class="card-body">
								<div class="media align-items-center">
									...
									<div class="media-body text-right">
										<p class="fs-18 text-white mb-2">Data Admin</p>
										<span class="fs-48 text-white font-w600"><?php echo $admin ?></span>
									</div>
								</div>
							</div>
						</div>
