...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="373" height="336">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="hak_akses" value="<?php echo htmlentities($row_rs_profile['hak_akses'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="form-control input-sm" required/></td>
    </tr>
    <tr valign="baseline">
