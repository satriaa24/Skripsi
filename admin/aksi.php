...
/** alternatif */    
else if($page=='admin/admin_tambah'){
    $kode = $_POST['kode'];
    $nama = $_POST['nama'];
    $alamat = $_POST['alamat'];
    $tanggal_lahir = $_POST['tanggal_lahir'];
   ...
   elseif($db->get_results("SELECT * FROM tb_alternatif WHERE kode_alternatif='$kode'"))
        ...
        swal({
         ...
         window.location = "?page=admin/view";
       });
                 </script>';
    }                    
} else if($page=='admin/admin_ubah'){
    $nama = $_POST['nama'];
	$alamat = $_POST['alamat'];
	$tanggal_lahir = $_POST['tanggal_lahir'];
	$username = $_POST['username'];
    ...
    $db->query("DELETE FROM tb_alternatif WHERE kode_alternatif='$_GET[ID]'");
     echo"<script>alert('Data Berhasil DiHapus'); window.location='hm.php?page=admin/view';</script>";
}     
/** KRITERIA */    
   ...
   elseif($db->get_results("SELECT * FROM tb_kriteria WHERE kode_kriteria='$kode'"))
        ...
        $db->query("INSERT INTO tb_kriteria (kode_kriteria, nama_kriteria, bobot, jenis) VALUES ('$kode', '$nama', '$bobot', '$jenis')"); 
   ...
   window.location = "?page=kriteria/view";
    ...
    if( $nama==''||$bobot=='')
        print_msg("Field bertanda * tidak boleh kosong!");
         ...
         $db->query("UPDATE tb_kriteria SET nama_kriteria='$nama', bobot='$bobot', jenis='$jenis' WHERE kode_kriteria='$_GET[ID]'");
        echo '<script>
  swal({
   title: "Good job!",
   text: "Data berhasil DiUbah",
...
/** rel_alternatif_ubah */ 
...
else if($page=='nilai/nilai_tambah'){
    $kode_kriteria = $_POST['kode_kriteria'];
  ...
  swal({
   ...
   window.location = "?page=nilai/view";
 });
           </script>';
    }                    
} else if($page=='nilai/nilai_ubah'){
    $kode_kriteria = $_POST['kode_kriteria'];
    $nama_subkriteria = $_POST['nama_subkriteria'];
    $nilai = $_POST['nilai'];
    ...
    if( $kode_kriteria==''||$nilai=='')
        print_msg("Field bertanda * tidak boleh kosong!");
         ...
         $db->query("UPDATE tb_nilai SET kode_kriteria='$kode_kriteria', nama_subkriteria='$nama_subkriteria', nilai='$nilai' WHERE id_nilai='$_GET[ID]'");
        echo '<script>
  swal({
   title: "Good job!",
   text: "Data berhasil DiUbah",
   ...
   window.location = "?page=nilai/view";
    ...
    echo"<script>alert('Data Berhasil DiHapus'); window.location='hm.php?page=nilai/view';</script>";
