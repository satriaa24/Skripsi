...
$query_rs_alternatif = "SELECT kode_alternatif, nama_alternatif, hak_akses FROM tb_alternatif where 1 = 1 AND hak_akses='admin' ORDER BY kode_alternatif ASC ";
...
-->
 ...
 <!-- <p><a href="?page=admin/admin_tambah" class="btn btn-xs btn-primary"><span class="fa fa-save"></span> Insert Data</a> </p> -->
  ...
  <div class="card-body">
    <div class="panel-heading">
          <div class="form-group">
                <a class="btn btn-primary btn-rounded" href="?page=admin/admin_tambah"><span class="fa fa-save"></span> Tambah Admin</a>
        </div>
    </div>
     ...
     <tr align="center">
       ...
       <td>
													<div class="d-flex justify-content-center">
														<a href="?page=admin/admin_ubah&amp;ID=<?php echo $row_rs_alternatif['kode_alternatif']; ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
														<a href="aksi.php?act=admin_hapus&amp;ID=<?php echo $row_rs_alternatif['kode_alternatif']; ?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
													</div>												
												</td>	
       </tr>
