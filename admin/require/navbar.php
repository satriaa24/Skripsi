                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            ...
                            Hi, welcome back! <?php echo $nama_alternatif2 ; ?>
                            </div>
                        </div>
						...
						<!-- <li class="nav-item">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_960_720.png" width="20" alt=""/>
									<div class="header-info">
										<span class="text-black"><?php echo $nama_alternatif2 ?></span>
										<p class="fs-12 mb-0"><?php echo $hak_akses2 ?></p>
									</div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
