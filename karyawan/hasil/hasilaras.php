...
<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Proses Perhitungan Hasil Seleksi 2</h4>
                            </div>
                            <div class="card-body">
...
<br>
    <div class="text-right">
                            <form action="" method="post">
                                <button class="btn btn-success" type="submit" name="form_report"><b>Lihat Hasil Seleksi FInal</b></button>
                            </form>
                        </div>
                </div>
            </div>
